...
| Unit | K | Archetypes |
|---|---|---|
| `cb` | 3 | Stopper, Sweeper, Ball-Playing Defender |
| `fb` | 3 | Inverted Fullback, Defensive Fullback, Overlapping Wingback |
| `mf` | 4 | Advanced Playmaker, Deep-Lying Playmaker, Destroyer, Box-to-Box Midfielder |
| `wg` | 3 | Touchline Winger, Inside Forward, Wide Playmaker |
| `st` | 3 | False 9, Poacher, Target Man |
